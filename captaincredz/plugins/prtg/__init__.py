class Plugin:
    ...
    def testconnect(self, useragent):
        ...
        """
        url = f'{self.pluginargs["url"].rstrip("/")}/public/checklogin.htm'
        r = self.requester.get(url, headers={"User-Agent": useragent})
        return "PRTG Network Monitor" in r.text
